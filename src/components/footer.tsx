      ...
      <div className="w-full">
        <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1 gap-3">
          <div className="flex flex-col gap-2">
            ...
            <a href={"https://www.facebook.com/"+schoolConfig?.fb} className="flex gap-2 items-center text-sm text-gray-500 hover:underline"> <BsFacebook size={24} />  {schoolConfig?.name}</a>
            <a href={"https://www.instagram.com/"+schoolConfig?.ig} className="flex gap-2 items-center text-sm text-gray-500 hover:underline"> <BsInstagram size={24} />{schoolConfig?.name}</a>
          </div>
