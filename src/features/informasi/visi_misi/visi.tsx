...
export const Visi = () => {
    return (
      <div>
        <div className="relative isolate px-6 lg:px-40 mx-auto py-24 flex gap-10 justify-center items-center">
          <h1 className="text-pretty text-6xl font-semibold text-gray-900 -rotate-90 p-5 bg-green-300">VISI</h1>
