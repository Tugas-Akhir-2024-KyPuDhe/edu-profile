...
export const Misi = () => {
    return (
      <div>
        <div className="relative isolate px-6 md:px-24 lg:px-32 mx-auto py-24 flex gap-10 justify-center items-center">
          <h1 className="text-pretty text-6xl font-semibold text-gray-900 -rotate-90 p-5 bg-red-300">MISI</h1>
