  ...
  return (
    <div ref={ref1} className={`py-16 px-6 md:px-24 lg:px-32 bg-green-300 grid grid-cols-2 gap-4 lg:grid-cols-4 transition ease-in duration-700 ${isVisible1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <div className="flex flex-col items-center">
            ...
            <h5 className="mb-1 text-4xl font-medium text-gray-700">{data?.student}</h5>
            <span className="text-xl font-medium text-gray-700">Siswa</span>
        </div>
        <div className="flex flex-col items-center">
            <FaUserSecret size={30} className="text-gray-700"/>
            <h5 className="mb-1 text-4xl font-medium text-gray-700">{data?.teacher}</h5>
            <span className="text-xl font-medium text-gray-700">Guru</span>
        </div>
        <div className="flex flex-col items-center">
            <FaUserGraduate size={30} className="text-gray-700"/>
            <h5 className="mb-1 text-4xl font-medium text-gray-700">{data?.alumni}</h5>
            <span className="text-xl font-medium text-gray-700">Alumni</span>
        </div>
        <div className="flex flex-col items-center">
            <FaUserTie size={30} className="text-gray-700"/>
            <h5 className="mb-1 text-4xl font-medium text-gray-700">{data?.staff}</h5>
